...
CONSTANT.SPACE_NAME = 'acl_v6'

CONSTANT.ID         = 'id'
CONSTANT.SUB_ID     = 'sub_id'
...
CONSTANT.FORMAT = {
    ...
    { name = CONSTANT.SUB_ID,     type = 'unsigned' },
...
CONSTANT.INDEX_BY_ID_FIELDS = { CONSTANT.ID, CONSTANT.SUB_ID }
...
CONSTANT.INDEX_BY_COORD_DIMENSION = 4
